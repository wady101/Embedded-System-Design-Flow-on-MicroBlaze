...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../lab5.srcs/sources_1/bd/system/ipshared/b65a" \
       +incdir+"$ref_dir/../../../../lab5.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../lab5.srcs/sources_1/bd/system/ipshared/b65a" \
       +incdir+"../../../../lab5.srcs/sources_1/bd/system/ipshared/ec67/hdl"
}
