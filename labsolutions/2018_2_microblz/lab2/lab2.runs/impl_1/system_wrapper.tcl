...
set rc [catch {
  ...
  open_checkpoint C:/xup/embedded/2018_2_microblz/lab2/lab2.runs/impl_1/system_wrapper.dcp
  ...
  set_property ip_output_repo C:/xup/embedded/2018_2_microblz/lab2/lab2.cache/ip [current_project]
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files c:/xup/embedded/2018_2_microblz/lab2/lab2.srcs/sources_1/bd/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf
  set_property SCOPED_TO_REF system [get_files -all c:/xup/embedded/2018_2_microblz/lab2/lab2.srcs/sources_1/bd/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf]
  set_property SCOPED_TO_CELLS microblaze_0 [get_files -all c:/xup/embedded/2018_2_microblz/lab2/lab2.srcs/sources_1/bd/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf]
